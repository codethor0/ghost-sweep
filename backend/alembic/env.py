...
INI_DATABASE_URL = "postgresql+asyncpg://ghost_sweep:ghost_sweep@localhost:5432/ghost_sweep"

config = context.config
settings = get_settings()
configured_url = config.get_main_option("sqlalchemy.url") or ""
if configured_url == INI_DATABASE_URL:
    configured_url = ""

if not configured_url:
    configured_url = os.getenv("TEST_DATABASE_URL") or settings.database_url
